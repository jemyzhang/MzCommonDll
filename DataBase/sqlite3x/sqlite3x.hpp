...
namespace sqlite3x {
	...
	class COMMON_API sqlite3_transaction {
	private:
		sqlite3_transaction(const sqlite3_transaction& s);
	...
	class COMMON_API sqlite3_command{
	private:
		sqlite3_command(const sqlite3_command& s);
	...
	class COMMON_API sqlite3_reader {
	private:
		friend class sqlite3_command;
